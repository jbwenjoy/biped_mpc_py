...
class MujocoSimBase:
    ...
    def obj_name2id(self, name, type="body"):
        type = type.upper()
        return mujoco.mj_name2id(self.model, getattr(mujoco.mjtObj, "mjOBJ_" + type), name)

    def obj_id2name(self, obj_id, type="body"):
        type = type.upper()
        return mujoco.mj_id2name(self.model, getattr(mujoco.mjtObj, "mjOBJ_" + type), obj_id)
